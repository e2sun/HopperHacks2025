...
function loadQuizStart() {
    ...
    mainContent.innerHTML = `
        ...
        <p> For each question, choose the option that resonates the most with you. At the end of the quiz, you will get matched
        with the Wolfie that best matches your personality. If you want to get in touch with other Seawolves that have the same
        personality type as you, add yourself as a user and meet with other people.</p>
